public class gfg_Generalised_Fibonacci_numbers {
    ...
    public static void main(String[] args) {
        ...
        long result = gfg_Generalised_Fibonacci_numbers.genFibNum(a, b, c, n, m);

        System.out.println("Generalized Fibonacci Number for n=" + n + ": " + result);
    }
}
